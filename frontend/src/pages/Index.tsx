  ...
  return (
    <MainLayout>
      <div className="flex flex-col min-h-screen">
        <TopBar />
        <div className="flex-1 p-6 lg:p-10 space-y-8 max-w-[1600px] mx-auto w-full">
          <div className="animate-fade-in-up" style={{ animationDelay: '0ms' }}>
            <h1 className="text-4xl font-extrabold text-white tracking-tight">Dashboard</h1>
            <p className="text-muted-foreground mt-2 text-lg">Welcome back, <span className="text-primary font-semibold">John</span>. Here's your rental overview.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            <WeeklyActivityChart />
            <TopCustomersChart />
            <RentalInsights />
          </div>
